                ...
                <div class="box">
                    <div id="path" class="path-top">
                        <ol class="breadcrumb" itemscope itemtype="http://schema.org/BreadcrumbList">
                            ...
                            <li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
                                <a itemprop="item" href="chapchu.php?machap=<?php echo $chitietchap["IdChapter"]; ?>">
                    ...
                    <h1 class="detail-title"><a href="chapchu.php?machap=<?php echo $chitietchap["IdChapter"]; ?>"><?php echo $chitietchap["TenManga"]; ?></a> Chap <?php echo $chitietchap["SttChap"] ?></h1>
                </div>
...
<br />                </div> -->
                <div class="detail-content">
                    <div class="detail-content-title">
                        Chương <?php echo $chitietchap["SttChap"]; ?> : <?php echo $chitietchap["TenChap"] ?>
                    </div>
                    <div class="detail-content-content">
                       <?php echo htmlspecialchars_decode(stripslashes($chitietchap["Noidung"])); ?>
                    </div>
                </div>
